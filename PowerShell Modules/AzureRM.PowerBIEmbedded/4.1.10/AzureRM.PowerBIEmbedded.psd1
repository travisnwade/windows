#
# Module manifest for module 'PSGet_AzureRM.PowerBIEmbedded'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fix failure in Update-AzureRmPowerBIEmbeddedCapacity when trying to scale paused capacity
